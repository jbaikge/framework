...
function sync_database ($tables = null, $queries = null, $noisy = true) {
	if ($tables) {
...
function preview_mode ($on = null) {
	if ($on !== null) {
		$_ENV['config']['mode.preview'] = (bool)$on;
	}
	return $_ENV['config']['mode.preview'];
}
